    ...
    <div class="table-responsive  "> 
        ...
        <table style="text-align:center" class="table">
            ...
            if (isset($conexio)) {
                ...
                $sql3 = "SELECT * FROM Assignatures WHERE Assignatures.quadri='Q2' or Assignatures.quadri='tots' ";
                ...
                foreach ($resultat3 as $fila3) {
                    ...
                    $sql2 = "SELECT professor, assignatura, tipus, quadri, cast(cast(grups as DECIMAL(3,2)) as float) as grups FROM Globals WHERE Globals.quadri='Q2' or Globals.quadri='tots'";
